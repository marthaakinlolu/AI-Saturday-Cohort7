...
with open(r'C:\Users\martha\Documents\cohort7-team-Machel\cohort7_practicals\webscraping_and_data_labelling\env.yml') as file:
    ENV = yaml.full_load(file) # TODO: Load `env.yml` using yaml into an `ENV` variable
...
def scrape(output_file_name: str, no_of_articles: int, category_urls: dict, time_delay: bool) -> None:
    ...
    with open(output_file_name, "w", encoding="utf-8") as csv_file:
        headers = ["headline", "paragraphs", "category", "url"]
